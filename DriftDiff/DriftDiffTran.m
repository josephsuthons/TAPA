...
% Simulation = 'PAW6_SetGaussian2CarParasRCOnly'; % PA Week 6 - Task 1
Simulation = 'LinGrad_PNJctEqBias'; % PA Week 6 - Task 2
...
elseif strcmp(Simulation,'PAW6_SetGaussian2CarParasRCOnly')
    eval('PAW6_SetGaussian2CarParasRCOnly');
elseif strcmp(Simulation,'LinGrad_PNJctEqBias')
    eval('LinGrad_SetPNJctParasEqBCBias');
end
